    ...
    <body>
     ...
     <div class="center">
       <div class='col s12 m12 l12'>
         ...
         </th><th><a href="adminbookingviewdesign.php">DesignChoice</a></th><th><a href="adminbookingviewstyle.php">StyleChoice</a></th><th></th></tr>
     <?php

       $sql = "SELECT booking.BookingID, booking.ColourChoice, booking.DesignChoice, booking.StyleChoice, user.Username FROM booking INNER JOIN user ON user.CustomerID = booking.CustomerID ORDER BY DesignChoice";
